...
var _ir4y$elm_dnd$DnD_ops = _ir4y$elm_dnd$DnD_ops || {};
_ir4y$elm_dnd$DnD_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _ir4y$elm_dnd$DnD$px = function (number) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(number),
		'px');
};
var _ir4y$elm_dnd$DnD$draggedStyle = function (position) {
	return _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: A2(_ir4y$elm_dnd$DnD_ops['=>'], 'position', 'absolute'),
			_1: {
				ctor: '::',
				_0: A2(
					_ir4y$elm_dnd$DnD_ops['=>'],
					'left',
					_ir4y$elm_dnd$DnD$px(position.x + 10)),
				_1: {
					ctor: '::',
					_0: A2(
						_ir4y$elm_dnd$DnD_ops['=>'],
						'top',
						_ir4y$elm_dnd$DnD$px(position.y + 10)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _ir4y$elm_dnd$DnD$dragged = F2(
	function (_p0, view) {
		var _p1 = _p0;
		return A2(
			...
			A2(
				...
				function (_p2) {
					...
					return A2(
						...
						{
							ctor: '::',
							_0: _ir4y$elm_dnd$DnD$draggedStyle(_p3.position),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: view(_p3.dragMeta),
							_1: {ctor: '[]'}
						});
				},
				_p1._0));
	});
var _ir4y$elm_dnd$DnD$getDragMeta = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$core$Maybe$map,
		function (_) {
...
var _ir4y$elm_dnd$DnD$getDropMeta = function (_p6) {
	var _p7 = _p6;
	return A2(
...
var _ir4y$elm_dnd$DnD$DraggableInit = F4(
	function (a, b, c, d) {
		return {model: a, subscriptions: b, draggable: c, droppable: d};
	});
var _ir4y$elm_dnd$DnD$Draggable = function (a) {
	return {ctor: 'Draggable', _0: a};
};
var _ir4y$elm_dnd$DnD$update = F2(
	function (msg, _p8) {
		var _p9 = _p8;
		var _p11 = _p9._0;
		var _p10 = msg;
		switch (_p10.ctor) {
			case 'DragStart':
				return _ir4y$elm_dnd$DnD$Draggable(
					_elm_lang$core$Maybe$Just(
						{dragMeta: _p10._0, position: _p10._1, dropMeta: _elm_lang$core$Maybe$Nothing}));
			case 'Dragging':
				return _ir4y$elm_dnd$DnD$Draggable(
					A2(
						_elm_lang$core$Maybe$map,
						...
						_p11));
			case 'DragEnd':
				return _ir4y$elm_dnd$DnD$Draggable(_elm_lang$core$Maybe$Nothing);
			case 'EnterDroppable':
				return _ir4y$elm_dnd$DnD$Draggable(
					A2(
						_elm_lang$core$Maybe$map,
						function (d) {
							return _elm_lang$core$Native_Utils.update(
								d,
								{
									dropMeta: _elm_lang$core$Maybe$Just(_p10._0)
								});
						},
						_p11));
			default:
				return _ir4y$elm_dnd$DnD$Draggable(
					A2(
						...
						function (d) {
							return _elm_lang$core$Native_Utils.update(
								d,
								{dropMeta: _elm_lang$core$Maybe$Nothing});
						},
						_p11));
		}
	});
var _ir4y$elm_dnd$DnD$LeaveDroppable = {ctor: 'LeaveDroppable'};
var _ir4y$elm_dnd$DnD$EnterDroppable = function (a) {
	return {ctor: 'EnterDroppable', _0: a};
};
var _ir4y$elm_dnd$DnD$droppable = F4(
			...
			A2(
				...
				attrs,
				{
					...
					_0: _elm_lang$html$Html_Events$onMouseEnter(
						wrap(
							_ir4y$elm_dnd$DnD$EnterDroppable(dropMeta))),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onMouseLeave(
							wrap(_ir4y$elm_dnd$DnD$LeaveDroppable)),
						_1: {ctor: '[]'}
					}
				}),
			html);
	});
var _ir4y$elm_dnd$DnD$DragEnd = function (a) {
	return {ctor: 'DragEnd', _0: a};
};
var _ir4y$elm_dnd$DnD$Dragging = function (a) {
	return {ctor: 'Dragging', _0: a};
};
var _ir4y$elm_dnd$DnD$subscriptions = F3(
	function (wrap, onDrop, _p12) {
		var _p13 = _p12;
		var _p14 = _p13._0;
				...
				return _elm_lang$core$Platform_Sub$batch(
					{
						...
						_0: _elm_lang$mouse$Mouse$moves(
							function (_p16) {
								return wrap(
									_ir4y$elm_dnd$DnD$Dragging(_p16));
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$mouse$Mouse$ups(
								_elm_lang$core$Basics$always(
									A2(onDrop, _p15._0, _p20.dragMeta))),
							_1: {
								ctor: '::',
								_0: _elm_lang$mouse$Mouse$ups(
									function (_p17) {
										return wrap(
											_ir4y$elm_dnd$DnD$DragEnd(_p17));
									}),
								_1: {ctor: '[]'}
							}
						}
				...
				return _elm_lang$core$Platform_Sub$batch(
					{
						...
						_0: _elm_lang$mouse$Mouse$moves(
							function (_p18) {
								return wrap(
									_ir4y$elm_dnd$DnD$Dragging(_p18));
							}),
						_1: {
							ctor: '::',
							_0: _elm_lang$mouse$Mouse$ups(
								function (_p19) {
									return wrap(
										_ir4y$elm_dnd$DnD$DragEnd(_p19));
								}),
							_1: {ctor: '[]'}
						}
					});
...
var _ir4y$elm_dnd$DnD$DragStart = F2(
	function (a, b) {
		return {ctor: 'DragStart', _0: a, _1: b};
	});
var _ir4y$elm_dnd$DnD$draggable = F4(
				...
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A3(
						...
						A2(
							...
							function (_p21) {
								return wrap(
									A2(_ir4y$elm_dnd$DnD$DragStart, meta, _p21));
							},
							_elm_lang$mouse$Mouse$position)),
					_1: {ctor: '[]'}
				},
...
var _ir4y$elm_dnd$DnD$init = F2(
	function (wrap, onDrop) {
		return {
			model: _ir4y$elm_dnd$DnD$Draggable(_elm_lang$core$Maybe$Nothing),
			subscriptions: A2(_ir4y$elm_dnd$DnD$subscriptions, wrap, onDrop),
			draggable: _ir4y$elm_dnd$DnD$draggable(wrap),
			droppable: _ir4y$elm_dnd$DnD$droppable(wrap)
		};
	});
...
var _user$project$Equipment$initialModel = F2(
	function (charisma, wisdom) {
		var rations = (wisdom / 2) | 0;
		var coins = charisma;
		var adventuringGear = (wisdom / 2) | 0;
		return {
			adventuringGear: _elm_lang$core$Maybe$Just(adventuringGear),
			adventuringGearText: _elm_lang$core$Basics$toString(adventuringGear),
			coins: _elm_lang$core$Maybe$Just(coins),
			coinsText: _elm_lang$core$Basics$toString(coins),
			editing: false,
			otherItems: '',
			rations: _elm_lang$core$Maybe$Just(rations),
			rationsText: _elm_lang$core$Basics$toString(rations)
		};
	});
var _user$project$Equipment$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {adventuringGear: a, adventuringGearText: b, coins: c, coinsText: d, editing: e, otherItems: f, rations: g, rationsText: h};
	});
var _user$project$Equipment$Wisdom = function (a) {
	return {ctor: 'Wisdom', _0: a};
};
var _user$project$Equipment$OtherItems = function (a) {
	return {ctor: 'OtherItems', _0: a};
};
var _user$project$Equipment$FocusOtherItems = function (a) {
	return {ctor: 'FocusOtherItems', _0: a};
};
var _user$project$Equipment$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Charisma':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							coins: _elm_lang$core$Maybe$Just(_p1),
							coinsText: _elm_lang$core$Basics$toString(_p1)
						}),
					{ctor: '[]'});
			case 'Editing':
				var _p2 = _p0._0;
				var cmds = _p2 ? {
					...
					_0: A2(
						_elm_lang$core$Task$attempt,
						_user$project$Equipment$FocusOtherItems,
						_elm_lang$dom$Dom$focus('other-items')),
					_1: {ctor: '[]'}
				} : {ctor: '[]'};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Equipment$Editing = function (a) {
	return {ctor: 'Editing', _0: a};
};
var _user$project$Equipment$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('sword'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$name('equipment'),
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value('sword'),
														_1: {ctor: '[]'}
													}
												}
											}
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$label,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$for('sword'),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Sword (1d8 damage close) and chainmail (1 armor)'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('pistol'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$name('equipment'),
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$value('pistol'),
															_1: {ctor: '[]'}
														}
													}
												}
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$label,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$for('pistol'),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Pistol, Bow or Throwing Knives (1d8 damage near) and 3 ammo'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('magic-missile'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$name('equipment'),
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value('magic-missile'),
																_1: {ctor: '[]'}
															}
														}
													}
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$label,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$for('magic-missile'),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Magic Missile spell (2d4 damage far, must defy\n                        danger with INT to use) and dagger (1d4 damage close)'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('hammer'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$name('equipment'),
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value('hammer'),
																	_1: {ctor: '[]'}
																}
															}
														}
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$label,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$for('hammer'),
															_1: {ctor: '[]'}
														}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Cure Light Wounds spell (heal 1d8 damage, must\n                        defy danger with WIS to use) and hammer (1d6 damage close)'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('row mt-1'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
																				...
																				},
																				{
																					...
																					_0: A2(
																						_elm_lang$html$Html$input,
																						{
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$id('coins'),
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$min('0'),
																									_1: {
																										...
																										_1: {
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$value(model.coinsText),
																											_1: {ctor: '[]'}
																										}
																									}
																								}
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('col-md-12 col-xl-7 mt-md-1 mt-xl-0'),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_user$project$Equipment$Editing(true)),
																_1: {ctor: '[]'}
															}
														},
														{
																		...
																		var visible = model.editing ? A2(
																			_elm_lang$html$Html$textarea,
																			{
																				...
																				_1: {
																					...
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$id('other-items'),
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Events$onBlur(
																								_user$project$Equipment$Editing(false)),
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Events$onInput(_user$project$Equipment$OtherItems),
																								_1: {
																									ctor: '::',
...
var _user$project$Equipment$Charisma = function (a) {
	return {ctor: 'Charisma', _0: a};
};

var _user$project$Health$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Armor':
				var armor = _elm_lang$core$Result$toMaybe(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							armorText: A2(
								_elm_lang$core$Maybe$withDefault,
								model.armorText,
								A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, armor))
						}),
					{ctor: '[]'});
			case 'Constitution':
				var _p1 = _p0._0;
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							currentHP: _elm_lang$core$Maybe$Just(_p1),
							currentHPText: _elm_lang$core$Basics$toString(_p1),
							maximumHP: _elm_lang$core$Maybe$Just(_p1),
							maximumHPText: _elm_lang$core$Basics$toString(_p1)
						}),
					{ctor: '[]'});
			case 'CurrentHP':
				var currentHP = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p0._0));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							currentHPText: A2(
								_elm_lang$core$Maybe$withDefault,
								model.currentHPText,
								A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, currentHP))
						}),
					{ctor: '[]'});
			case 'LevelUp':
				var xp = A2(
					_elm_lang$core$Maybe$map,
					function (x) {
						return A2(_elm_lang$core$Basics$max, 0, x - 5);
					},
					model.xp);
				var _p2 = A2(
					_mgold$elm_random_pcg$Random_Pcg$step,
					A2(_mgold$elm_random_pcg$Random_Pcg$int, 1, 6),
					model.seed);
				var inc = _p2._0;
				var seed = _p2._1;
				var maximumHP = A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							maximumHPText: A2(
								_elm_lang$core$Maybe$withDefault,
								'',
								A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, maximumHP)),
							seed: seed,
							xp: xp,
							xpText: A2(
								_elm_lang$core$Maybe$withDefault,
								model.xpText,
								A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, xp))
						}),
					{ctor: '[]'});
			case 'MaximumHP':
				var maximumHP = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p0._0));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
					...
					{ctor: '[]'});
			default:
				var xp = _elm_lang$core$Result$toMaybe(
					_elm_lang$core$String$toInt(_p0._0));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
...
var _user$project$Health$initialModel = F2(
	function (seed, constitution) {
		var constitutionText = _elm_lang$core$Basics$toString(constitution);
		return {
			armor: _elm_lang$core$Maybe$Just(0),
			armorText: '0',
			currentHP: _elm_lang$core$Maybe$Just(constitution),
			currentHPText: constitutionText,
			maximumHP: _elm_lang$core$Maybe$Just(constitution),
			maximumHPText: constitutionText,
			seed: seed,
			xp: _elm_lang$core$Maybe$Just(0),
			xpText: '0'
		};
	});
var _user$project$Health$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {armor: a, armorText: b, currentHP: c, currentHPText: d, maximumHP: e, maximumHPText: f, seed: g, xp: h, xpText: i};
	});
var _user$project$Health$XP = function (a) {
	return {ctor: 'XP', _0: a};
};
var _user$project$Health$MaximumHP = function (a) {
	return {ctor: 'MaximumHP', _0: a};
};
var _user$project$Health$LevelUp = {ctor: 'LevelUp'};
var _user$project$Health$CurrentHP = function (a) {
	return {ctor: 'CurrentHP', _0: a};
};
var _user$project$Health$Constitution = function (a) {
	return {ctor: 'Constitution', _0: a};
};
var _user$project$Health$Armor = function (a) {
	return {ctor: 'Armor', _0: a};
};
var _user$project$Health$view = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
...
var _user$project$Moves$view = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('border border-primary mt-1 rounded row'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-md-6 col-xl-4'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_evancz$elm_markdown$Markdown$toHtml,
							{ctor: '[]'},
							_user$project$Moves$hackAndSlash),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									_evancz$elm_markdown$Markdown$toHtml,
									{ctor: '[]'},
									_user$project$Moves$aidOrInterfere),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										_evancz$elm_markdown$Markdown$toHtml,
										{ctor: '[]'},
										_user$project$Moves$defyDanger),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													_evancz$elm_markdown$Markdown$toHtml,
													{ctor: '[]'},
													_user$project$Moves$discernRealities),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															_evancz$elm_markdown$Markdown$toHtml,
															{ctor: '[]'},
															_user$project$Moves$lastBreath),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
...
var _user$project$Scores$modifiers = function (_p0) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(
			_elm_lang$core$Maybe$map,
			function (s) {
				return (_elm_lang$core$Native_Utils.cmp(s, 3) < 1) ? '-3' : ((_elm_lang$core$Native_Utils.cmp(s, 5) < 1) ? '-2' : ((_elm_lang$core$Native_Utils.cmp(s, 8) < 1) ? '-1' : ((_elm_lang$core$Native_Utils.cmp(s, 12) < 1) ? '0' : ((_elm_lang$core$Native_Utils.cmp(s, 15) < 1) ? '+1' : ((_elm_lang$core$Native_Utils.cmp(s, 17) < 1) ? '+2' : '+3')))));
			},
			_p0));
};
var _user$project$Scores$maybeScore = function (value) {
	return {
		...
		text: A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toString, value))
	};
};
var _user$project$Scores$strDown = function (model) {
	return {
		ctor: '_Tuple3',
...
var _user$project$Scores$dragged = function (model) {
	var box = function (value) {
		return A2(
			_elm_lang$html$Html$h3,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('align-middle bg-white border-thick rounded text-center text-info'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
...
var _user$project$Scores$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {cha: a, con: b, dex: c, draggable: d, $int: e, locked: f, scores: g, seed: h, str: i, wis: j};
									};
								};
							};
						};
...
var _user$project$Scores$Rolls = F6(
	function (a, b, c, d, e, f) {
		return {str: a, dex: b, con: c, $int: d, wis: e, cha: f};
	});
var _user$project$Scores$rollScores = function (seed) {
	var gen = A2(
		_mgold$elm_random_pcg$Random_Pcg$map,
		function (d) {
			return _elm_lang$core$List$sum(d) - A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				_elm_lang$core$List$minimum(d));
		},
		A2(
...
var _user$project$Scores$Dropped = F2(
	function (a, b) {
		return {ctor: 'Dropped', _0: a, _1: b};
	});
var _user$project$Scores$DnDMsg = function (a) {
...
var _user$project$Scores$subscriptions = function (model) {
...
var _user$project$Scores$Constitution = {ctor: 'Constitution'};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Use the arrows or drag and drop to rearrange the scores.'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Scores$WisdomUp = function (a) {
...
var _user$project$Scores$ConstitutionUp = function (a) {
...
var _user$project$Scores$CharismaUp = function (a) {
...
var _user$project$Scores$dropped = F3(
	function (to, from, model) {
		if (_elm_lang$core$Native_Utils.eq(
			...
			return {
				...
				_0: model_,
				_1: _elm_lang$core$Platform_Cmd$none,
				_2: A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, upMsgs)
			};
		}
	});
var _user$project$Scores$reroll = function (model) {
	...
	return {
		...
		_2: {
			ctor: '::',
			_0: _user$project$Scores$CharismaUp(rolls.cha),
			_1: {
				ctor: '::',
				_0: _user$project$Scores$ConstitutionUp(rolls.con),
				_1: {
					ctor: '::',
					_0: _user$project$Scores$WisdomUp(rolls.wis),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Types$initialModel = function (randomSeed) {
	var seed = _mgold$elm_random_pcg$Random_Pcg$initialSeed(randomSeed);
	var _p0 = A2(
		_mgold$elm_random_pcg$Random_Pcg$step,
		A2(
			_mgold$elm_random_pcg$Random_Pcg$andMap,
			...
			A2(
				...
				_mgold$elm_random_pcg$Random_Pcg$independentSeed)),
		seed);
	var healthSeed = _p0._0._0;
	var scoresSeed = _p0._0._1;
	var _p1 = _user$project$Scores$initialModel(scoresSeed);
	var scores = _p1._0;
	var rolls = _p1._1;
	return {
...
var _user$project$Types$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Types$initialModel(flags),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
...
var _user$project$Types$HealthMsg = function (a) {
...
var _user$project$Main$header = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('border border-primary py-1 rounded row'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col-md-5 col-xl-4'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Quick Characters'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-md-5 col-xl-4 offset-md-2 offset-xl-4 text-right'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-target', '#license'),
									_1: {
										ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Copyright Ⓒ 2018, G. Ralph Kuntz, MD'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-labelledby', 'licenseLabel'),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('license'),
												_1: {
													ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'min-width', _1: '40rem'},
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Apache 2.0 License'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
														...
														},
														{
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Licensed under the Apache License, Version 2.0\n                                (the \"License\"); you may not use this file except\n                                in compliance with the License. You may obtain a\n                                copy of the License at'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$href('http://www.apache.org/licenses/LICENSE-2.0'),
																					_1: {
																						ctor: '::',
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('http://www.apache.org/licenses/LICENSE-2.0'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Source code available at '),
																					_1: {
																						ctor: '::',
																						_0: A2(
																							_elm_lang$html$Html$a,
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$href('https://github.com/grkuntzmd/DWQuickCharacters'),
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$target('_blank'),
																									_1: {ctor: '[]'}
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('https://github.com/grkuntzmd/DWQuickCharacters'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}
...
var _user$project$Main$demographics = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col-form-label col-3'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$for('select-character'),
								_1: {ctor: '[]'}
							}
						},
						{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('custom-select form-control'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('select-character'),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Select a character'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('btn btn-primary btn-sm rounded-circle'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
					...
					},
					{
						...
						_0: A2(
							_elm_lang$html$Html$label,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('character-name'),
									_1: {ctor: '[]'}
								}
							},
							{
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('character-name'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$type_('text'),
													_1: {ctor: '[]'}
										...
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('btn btn-danger btn-sm rounded-circle'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$title('Delete this character. This cannot be undone.'),
															_1: {ctor: '[]'}
														}
													}
												}
						...
						},
						{
							...
							_0: A2(
								_elm_lang$html$Html$label,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$for('character-race'),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('character-race'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$type_('text'),
														_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-md-6 col-xl-5'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _user$project$Main$demographics(model),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														_user$project$Types$ScoresMsg,
														_user$project$Scores$view(model.scores)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$map,
															_user$project$Types$HealthMsg,
															_user$project$Health$view(model.health)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$Types$ScoresMsg,
						_user$project$Scores$dragged(model.scores)),
					_1: {
						ctor: '::',
						_0: _user$project$Moves$view,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$subscriptions = function (model) {
	return A2(
		...
		_user$project$Types$ScoresMsg,
		_user$project$Scores$subscriptions(model.scores));
};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'AlignmentMsg':
				var _p1 = A2(_user$project$Alignment$update, _p0._0, model.alignment);
				var model_ = _p1._0;
				var cmd = _p1._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			default:
				...
				var _p6 = A3(
						...
						}),
					{
						...
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$ScoresMsg, scoresCmd),
							_1: {ctor: '[]'}
						}
					},
					upMsgs);
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Types$init, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions, view: _user$project$Main$view})(_elm_lang$core$Json_Decode$int);
